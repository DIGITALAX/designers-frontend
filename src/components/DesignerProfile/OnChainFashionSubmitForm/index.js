  ...
  return (
    <div className={styles.wrapper}>
      <p className={styles.description}>
        Upload items to be listed on the DIGITALAX polygon indie web3 fashion marketplace to be
        listed as NFTs. DIGITALAX takes on the minting fee. The DIGITALAX treasury takes 15% from
        the total sale.{' '}
      </p>
